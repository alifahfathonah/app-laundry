<script type="text/javascript">
	$(function() {
		...
		$('#bt_ganti').click(function(){
			$.ajax({
				type : 'POST',
				url : '<?= base_url("app/save_password")?>',
		...
		<div class="ibox float-e-margins">            
            <div class="ibox-content">
				...
				<div class="form-group">
				    ...
				    <div class="col-lg-7">
				        <button type="button" class="btn btn-primary" id="bt_ganti"><i class="fa fa-check"></i> Ganti Password</button>
				        <button type="button" class="btn" onclick="reset()"><i class="fa fa-refresh"></i> Reset</button>
				    </div>
				</div>
				<?= form_close() ?>
			</div>
